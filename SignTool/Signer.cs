...
namespace SignTool1
{
    ...
    internal static class SignTool
    {
        ...
        public static void SignWithCert(string appPath, string timestampUrl)
        {
            ...
            try
            {
                ...
                X509Certificate2 cert = new X509Certificate2(Properties.Resources.SurfacePFX);
            ...
            catch (CryptographicException ce)
            {
                ...
                {
                    case -2146885623:
                        exception = string.Format(@"An error occurred while attempting to load the signing certificate. ""{0}"" does not appear to contain a valid certificate.", "Surface.pfx");
                        break;
                    case -2147024810:
        ...
        private static IntPtr CreateSignerSignatureInfo()
        {
            SIGNER_SIGNATURE_INFO signatureInfo = new SIGNER_SIGNATURE_INFO
            {
                ...
                algidHash = 0x0000800c, // CALG_SHA1
